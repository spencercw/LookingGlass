...
void main()
{
  ...
  switch (colorSpace)
  {
    case COLOR_SPACE_SRGB:
      fbPx = vec4(srgbToLinear(fbPx.rgb), fbPx.a);
      break;
    ...
    case COLOR_SPACE_HDR10_ST2084:
      fbPx = vec4(st2084ToLinear(fbPx.rgb), fbPx.a);
      break;
  }
  ...
  // Do the blend
  vec3 blended = cursorPx.rgb * cursorPx.a + fbPx.rgb * (1.0 - cursorPx.a);
  ...
  switch (colorSpace)
  {
    ...
    case COLOR_SPACE_HDR10_ST2084:
    {
      blended = linearToSt2084(blended);
      break;
    }
  }

  color = vec4(blended, max(fbPx.a, cursorPx.a));
}
